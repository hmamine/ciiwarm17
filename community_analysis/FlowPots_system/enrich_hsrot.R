...
c.mat1 = makeContrasts ( config3root.full	-	config3root.hs, levels = finalMod1)
...
DT_1p=fit1$p.value
	...
	setnames(DT_1, "config3root.full - config3root.hs", "fc.FvsS")
	setnames(DT_1p, "config3root.full - config3root.hs", "p.FvsS")
